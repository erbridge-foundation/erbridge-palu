# jump-range Specification

## Purpose

Given a source system, a bridging hull, and a JDC level, report every K-space system
reachable in a single jump at the hull's effective jump range — a planning-oriented
reachability query that ignores the gate graph entirely.
